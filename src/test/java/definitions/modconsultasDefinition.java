...
/**
 * Clase modconsultasDefinition que contiene los metodos de los pasos a seguir en el archivo modconsultasfeature
...
public class modconsultasDefinition {
    ...
    public void seleccionarEstadoTurno(String estadoturno) {
        combobox.abrirComboboxEstadoTurno();
    ...
    @And("ingresar la compania {string}")
    public void ingresarLaCompania(String compania) {
