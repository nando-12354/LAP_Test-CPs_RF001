...
######## Liquidacion Stickers ########
  ...
  Scenario: CPF20x - Liquidacion stickers/Exportar pdf, excel e imprimir reporte de liquidacion de Stickers
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
...
######## Resumen Diario ########
  ...
  Scenario: CPF20x - Resumen diario/Exportar pdf, excel e imprimir reporte de resumen diario
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
...
######## Movimiento Tickets Contingencia ########
  ...
  Scenario: CPF214 - Movimiento tickets contingencia/Exportar pdf, excel e imprimir reporte movimiento tickets contingencia
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
...
######## Stock Tickets Contingencia ########
  ...
  Scenario: CPF217 - Stock Tickets Contingencia/Exportar pdf, excel e imprimir reporte de stock tickets contingencia
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
...
######## Detalle por Linea de Vuelo ########
  ...
  Scenario: CPF217 - Detalle por Linea de Vuelo/Exportar pdf, excel e imprimir reporte de detalle por linea de vuelo
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
  ...
  Scenario: CPF217 - BP leidos en el molinete/Exportar pdf, excel e imprimir reporte de bp leidos en el molinete
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
...
######## Tickets Vendidos al Credito o al Contado ########
  ...
  Scenario: CPF217 - Tickets vendidos al credito o al contado/Exportar pdf, excel e imprimir reporte de tickets vendidos al credito o al contado
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
...
######## Detalle Compañia ########
  ...
  Scenario: CPF217 - Detalle compania/Exportar pdf, excel e imprimir reporte de detalle compania
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
...
######## Tickets/BP Usados por Media Hora, Hora, Día o Mes ########
  ...
  Scenario: CPF217 - Tickets-BP usados por media hora, hora, dia o mes/Exportar pdf, excel e imprimir reporte de tickets-bp usados por media hora, hora, dia o mes
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
...
######## Tickets / BP Usados por Día - Mes ########
  ...
  Scenario: CPF217 - Tickets-BP usados por dia, mes/Exportar pdf, excel e imprimir reporte de tickets-bp usados por dia, mes
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
...
######## Recaudacion Mensual ########
  ...
  Scenario: CPF217 - Recaudacion mensual/Exportar pdf, excel e imprimir reporte de recaudacion mensual
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
...
######## Liquidación Venta ########
  ...
  Scenario: CPF217 - Liquidacion venta/Exportar pdf, excel e imprimir reporte de liquidacion venta
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
...
######## Tickets Vencidos ########
  ...
  Scenario: CPF217 - Tickets vencidos/Exportar pdf, excel e imprimir reporte de tickets vencidos
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
...
######## Cuadre Stickers vendidos / BP usados ########
  ...
  Scenario: CPF217 - Cuadre stickers vendidos-bp usados/Exportar pdf, excel e imprimir reporte de cuadre stickers vendidos-bp usados
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
...
######## Ticket / BP Rehabilitados ########
  ...
  Scenario: CPF217 - Ticket-bp rehabilitados/Exportar pdf, excel e imprimir reporte de ticket-bp rehabilitados
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
...
######## BP Rehabilitados ########
  ...
  Scenario: CPF217 - BP rehabilitados/Exportar pdf, excel e imprimir reporte de bp rehabilitados
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
...
######## Resumen Diario por Turno ########
  ...
  Scenario: CPF217 - Resumen diario por turno/Exportar pdf, excel e imprimir reporte de resumen diario por turno
    Given abre la ruta del aplicativo web
    And ingresa el usuario "fluyo"
    And ingresa la contrasena "fluyo987"
    And click en el boton iniciar sesion
