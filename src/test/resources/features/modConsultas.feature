...
######## TICKETS / BP USADOS ########
  ...
  Scenario: CPF178 - Tickets-bp usados/Buscar tickets-bp usados
    ...
    And validar columna "Estado Actual"
    And click en ver mas campos
    And validar datos del "Secuencial"
    And validar datos del "Número Asiento"
    And validar datos del "Destino"
    And validar datos del "Modalidad de Venta"
    And validar datos del "Tipo de Vuelo"
    And validar datos del "Tipo de Persona"
